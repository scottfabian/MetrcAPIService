...
public class MetrcApiException : Exception
{
    ...
    public MetrcApiException(HttpStatusCode statusCode, string response, string requestURL) : base() { this.StatusCode = statusCode; this.Response = response; this.RequestURI = requestURL; }
    ...
    public MetrcApiException(string message, HttpStatusCode statusCode, string response, string requestURL) : base(message) { this.StatusCode = statusCode; this.Response = response; this.RequestURI = requestURL; }
