...
public class TooManyRequestsException : MetrcApiException
{
    ...
    public TooManyRequestsException(HttpStatusCode statusCode, string response, string requestURL) : base("The limit of API calls allowed has been exceeded. Please pace the usage rate of the API more apart.", statusCode, response, requestURL) { }
}